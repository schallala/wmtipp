...
@Scope("session")
public class GroupEditController extends AbstractEditController<GroupDto> {

  @Autowired
  private IGroupService groupService;

  private static final Logger logger = LoggerFactory.getLogger(GroupEditController.class);
